...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-demo-ubuntu
echo     https://github.com/tfynes-pivotal/tap-gitops-demo-ubuntu
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-demo-ubuntu --public
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-demo-ubuntu
git branch -M main
